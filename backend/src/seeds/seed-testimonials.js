...
const testimonials = [
  ...
  { customerName: 'Grace Thompson', rating: 5, content: 'The Rooted Identity apparel line is stunning. I wear my pieces everywhere and always get compliments. Quality is outstanding.', isFeatured: true, isApproved: true },
  ...
  { customerName: 'Esther Okafor', rating: 5, content: 'The book collection is phenomenal. Every title speaks to something deep in my spirit. TKAYKONCEPTS truly creates products with purpose.', isFeatured: true, isApproved: true },
