  ...
  return (
    <AdminLayout>
      <div className="mb-8">
        ...
        <p className="mt-1 text-gray-500">Customize the homepage layout and sections</p>
      </div>
      <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 py-16 text-center">
        ...
        <p className="text-sm text-gray-400">Drag-and-drop builder to reorder, show/hide, and configure homepage sections.</p>
      </div>
    </AdminLayout>
  );
}
