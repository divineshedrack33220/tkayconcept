  ...
  return (
    <AdminLayout>
      <div className="mb-8">
        ...
        <p className="mt-1 text-gray-500">Manage Rooted Identity sub-brand content and products</p>
      </div>
      <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 py-16 text-center">
        ...
        <p className="text-sm text-gray-400">Manage Rooted Identity brand products, manifestos, and content.</p>
      </div>
    </AdminLayout>
  );
}
